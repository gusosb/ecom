      ...
      <Grid item xs={2}>
        ...
        >
          {categories.map((category, i) => (
            <>
              <ListItemButton
                onClick={() => navigate(`/admin/items/${category.id}`)}
                sx={{ backgroundColor: category.id === categoryID && !subCategoryID && '#F0F7FF' }}
              >
                <ListItemIcon>
                  <CategoryIcon />
                </ListItemIcon>
          ...
          {selectedCategory?.items && (
            <>
              ...
              <Grid item xs={12}>
                <TextField
                  value={newItem.name}
                  onChange={({ target }) => changeNewItem(target.value, 'name')}
                  id="outlined-basic"
                  label="Name"
                  variant="outlined"
                />
                <TextField
                  value={newItem.price}
                  onChange={({ target }) => changeNewItem(target.value, 'price')}
                  id="outlined-basic"
                  label="Price"
                  variant="outlined"
                />
                <TextField
                  value={newItem.vatRateSE}
                  onChange={({ target }) => changeNewItem(target.value, 'vatRateSE')}
                  id="outlined-basic"
                  label="vatRateSE"
                  variant="outlined"
                />
                        ...
                        {selectedCategory.items.map((row) => (
                          <TableRow
                            ...
                            sx={{
                              ...
                              backgroundColor: row.id === selectedItem.id && '#F0F7FF'
                            }}
                          >
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs="auto">
                          <TextField
                            ...
                            onChange={({ target }) => setSellable(target.value)}
                            id="outlined-basic"
                            label="Set Sellable stock"
                            variant="filled"
                          />
                          <br />
                          <TextField
                            value={vatRateSE}
                            InputLabelProps={{ shrink: true }}
                            onChange={({ target }) => setVatRateSE(target.value)}
                            id="outlined-basic"
                            label="Set vatRateSE"
                            variant="filled"
                          />
                          ...
                          <TextField
                            value={priceSEK}
                            InputLabelProps={{ shrink: true }}
                            onChange={({ target }) => setPriceSEK(target.value)}
                            id="outlined-basic"
                            label="Set price SEK"
                            variant="filled"
                          />
                          ...
                          <TextField
                            value={priceEUR}
                            InputLabelProps={{ shrink: true }}
                            onChange={({ target }) => setPriceEUR(target.value)}
                            id="outlined-basic"
                            label="Set price EUR"
                            variant="filled"
                          />
                          ...
                          <br />
                          <br />
                          <Button variant="contained" onClick={sendUpdateItem}>
                            Update item
                          </Button>
                          <br />
                          <br />
                          <TextField
                            value={imageIndex}
                            InputLabelProps={{ shrink: true }}
                            onChange={({ target }) => setImageIndex(target.value)}
                            id="outlined-basic"
                            label="Image index"
                            variant="filled"
                          />
                          ...
                          <br />
                          <br />
                          <Button variant="contained" onClick={sendAddImage}>
                            Add Image
                          </Button>
                        </Grid>
                        ...
                        <Grid item xs>
                          ...
                          />
                          <TextField
                            value={newVariantSellable}
                            InputLabelProps={{ shrink: true }}
                            onChange={({ target }) => setNewVariantSellable(target.value)}
                            id="outlined-basic"
                            label="Variant Sellable"
                            variant="filled"
                          />
                          {variantID ? (
                            <Button onClick={sendUpdateVariant} variant="contained">
                              Update Variant
                            </Button>
                          ) : (
                            <Button onClick={sendNewVariant} variant="contained">
                              New Variant
                            </Button>
                          )}
                        </Grid>
          ...
          {topCategoryID && !subCategoryID && (
            <>
              <Grid item xs>
                ...
                />
                <br />
                <Button variant="contained" onClick={() => sendUpdateCategory(topCategoryID)}>
                  Update Category
                </Button>
              </Grid>
            </>
          ...
          {subCategoryID && !selectedCategory.items && (
            <>
              <Grid item xs>
                ...
                <br />
                <br />
                <Button variant="contained" onClick={() => sendCategory('SubTwo', subCategoryID)}>
                  Create Category
                </Button>
                ...
                />
                <br />
                <Button variant="contained" onClick={() => sendUpdateCategory(subCategoryID)}>
                  Update category
                </Button>
              </Grid>
            </>
