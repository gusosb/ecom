      ...
      <Grid container>
        ...
        >
          <Typography paddingBottom={1} component="h1" variant="h6" style={{ fontWeight: 400 }}>
            ORDER CONFIRMATION #{result?.order_reference}
          </Typography>
        </Grid>
              ...
              return (
                ...
                >
                  <Grid container spacing={2} alignItems="center">
                    <Grid item xs="auto">
                      <Box component={Link} to={`/p/${item.product_id}/${item.name}`}>
                        <img src={path} alt="123" style={{ width: '90px' }} />
                      </Box>
                    </Grid>
                    <Grid item xs>
                      <Typography
                        ...
                        component={Link}
                        to={`/p/${item.product_id}/${item.name}`}
                      >
                        {item.name}
                      </Typography>
