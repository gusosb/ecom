...
const Discover = () => {
  return (
    <>
      <Helmet>
        <title>Surdegshörnan - Hem</title>
        <meta
          name="description"
          content="Välkommen till Surdegshörnan! Upptäck de bästa surdegsrecepten, tips och tricks för att baka det perfekta brödet. Perfekt för både nybörjare och erfarna bagare."
        />
        <link rel="canonical" href="http://www.surdegshornan.se/" />
      </Helmet>
      ...
      <Grid container spacing={1}>
        <Grid item xs={12} marginX={20} marginTop={5}>
          ...
          <Typography variant="body1" color="textSecondary" paragraph>
            Här på Surdegshörnan hittar du allt du behöver för att lyckas med
            ditt surdegsbak. För att få till ett riktigt bra surdegsbröd har vi
            försökt dokumentera receptet så noggrant som möjligt, med bilder som
            visar alla stegen, vi har också en instagram med videor som visar
            steg för steg hur du går tillväga, tveka inte att höra av dig på
        ...
        >
          ...
          <Box sx={{ marginLeft: "20px" }}>
            ...
            <Typography variant="body2" color="textSecondary">
              Efter 8h blanda din bubbliga surdegsgrund med 260g vatten, använd
              en degvisp eller händerna för att lösa upp surdegen i vattnet.
              Blanda i mjölet och rör ihop till en degklump, överarbeta inte
              degen, låt vila ca 40min.
            </Typography>
          </Box>
        </Grid>
        ...
        >
          ...
          <Box sx={{ marginLeft: "20px" }}>
            ...
            <Typography variant="body2" color="textSecondary">
              Låt degen jäsa i en temperatur på mellan 24° – 27°, i cirka 3 –
              4h. Du kan värma din ugn på 50° i 30 sekunder och jäsa degen där.
              <br />
              Under de första 2 timmarna gör du en sträck-och-vikning varje
              halvtimme. För att göra en sträck-och-vikning ta tag i undersidan
              av degen, sträck försiktigt degen uppåt och vik ner den under sig
              självt, gör detta 3 gånger tills degen är helt vänd.
              <br />
              När degen känns bullrig när du skakar på skålen och ser kullig ut
              är den redo att formas, häll ut den försiktigt på bordet.
            </Typography>
          </Box>
        </Grid>
        ...
        >
          ...
          <Box sx={{ marginLeft: "20px" }}>
            ...
            <Typography variant="body2" color="textSecondary">
              ...
              mitten.
              <br />
              Ta tag i båda sidorna och vik in ena sidan, vik sedan över den
              andra sidan.
              <br />
              ...
              <br />
              Mjöla en bakduk, helst i obehandlat linne, med en 50/50 blandning
              av rismjöl och vetemjöl och lägg den i botten av din jäskorg.
              <br />
              Använd din degskrapa och flytta degen till jäskorgen med ovansidan
              nedåt.
              <br />
              Du har nu två alternativ, låt degen jäsa i 24° – 27° i 3 - 4h,
              eller låt degen jäsa klart i kylskåpet över natten, 8 - 12h.
            </Typography>
          </Box>
        </Grid>
        ...
        >
          ...
          <Box>
            ...
            <Typography variant="body2" color="textSecondary">
              ...
              gjutgärnspanna med lock inne i ugnen. Ta ut degen om du har jäst
              den i kylskåpet under tiden.
              <br />
